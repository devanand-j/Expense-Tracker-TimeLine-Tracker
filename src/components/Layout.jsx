  ...
  const Sidebar = ({ mobile = false }) => (
    <div className={`flex h-full flex-col ${mobile ? '' : ''}`}>
      ...
      <div className="flex items-center gap-3 px-4 py-5">
        ...
        <div>
          <p className="text-[10px] font-bold uppercase tracking-widest text-teal">Team Portal</p>
          <p className="text-sm font-bold text-slate-900 dark:text-white leading-tight">Team Tracker</p>
        </div>
      </div>
        ...
        <header className="sticky top-0 z-30 flex h-14 items-center justify-between border-b border-[var(--surface-border)] bg-[var(--header-bg)] px-4 backdrop-blur-md">
          <div className="flex items-center gap-3">
            ...
            <Link to="/dashboard" className="flex items-center gap-2 lg:hidden">
              ...
              <span className="text-sm font-bold text-slate-900 dark:text-white">Team Tracker</span>
            </Link>
          </div>
